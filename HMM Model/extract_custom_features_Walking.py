...
df = pd.read_csv("pose_features_Walking.csv")
...
df_features.to_csv("reduced_features_Walking.csv", index=False)
print("reduced_features_Walking.csv saved!")

# Add label
df_features["label"] = "Walking"
df_features.to_csv("reduced_features_labeled_Walking.csv", index=False)
print("Labels added to reduced_features_labeled_Walking.csv")
