...
df = pd.read_csv("pose_features_Standing.csv")
...
df_features.to_csv("reduced_features_Standing.csv", index=False)
print("reduced_features_Standing.csv saved!")

# Add label
df_features["label"] = "Standing"
df_features.to_csv("reduced_features_labeled_Standing.csv", index=False)
print("Labels added to reduced_features_labeled_Standing.csv")
