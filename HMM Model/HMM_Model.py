...
gmm.fit(X_train)
train_observations = gmm.predict(X_train)
test_observations = gmm.predict(X_test)
...
true_labels_named = [idx_to_state[i] for i in true_labels]
predicted_labels_named = [idx_to_state[i] for i in viterbi_path]

# Compute precision, recall, f1 per label
precision = precision_score(true_labels_named, predicted_labels_named, average=None, labels=states)
recall = recall_score(true_labels_named, predicted_labels_named, average=None, labels=states)
f1 = f1_score(true_labels_named, predicted_labels_named, average=None, labels=states)
