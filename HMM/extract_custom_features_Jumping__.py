...
df_features.to_csv("reduced_features_Jumping.csv", index=False)
print("reduced_features_Jumping.csv saved!")

# Add label
df_features["label"] = "Jumping"
df_features.to_csv("reduced_features_labeled_Jumping.csv", index=False)
print("Labels added to reduced_features_labeled_Jumping.csv")
